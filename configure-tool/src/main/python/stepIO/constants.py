...
defaults[ConfigOptions['P1_UPLEFT_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P1_UPRIGHT_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P1_CENTER_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P1_DOWNLEFT_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P1_DOWNRIGHT_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P2_UPLEFT_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P2_UPRIGHT_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P2_CENTER_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P2_DOWNLEFT_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P2_DOWNRIGHT_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P1_COIN_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['P2_COIN_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['TEST_BUTTON_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['SERVICE_BUTTON_REMAP']] = EEPROM_DEFAULT_VALUE
defaults[ConfigOptions['CLEAR_BUTTON_REMAP']] = EEPROM_DEFAULT_VALUE
